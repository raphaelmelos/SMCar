...
<body>
    ...
    <section class="bancos">
        ...
        <div class="grid-bancos">
            ...
            <div class="banco">
                <p class="nome-banco">Bradesco</p>
                <div class="img-banco">
                    <img src="./assests/bradesco.jpg" alt="Banco 1">
                </div>
            </div>

            <div class="banco">
                <p class="nome-banco">Itaú</p>
                <div class="img-banco">
                    <img src="./assests/Banco_Itaú_logo.svg.png" alt="Banco 2">
                </div>
            </div>

            <div class="banco">
                <p class="nome-banco">Banco do Brasil</p>
                <div class="img-banco">
                    <img src="./assests/BB-logo1.jpg" alt="Banco 3">
                </div>
            </div>
